...
from qjazz_contrib.core.config import ConfigError, read_config_toml
...
class QgisServer(qjazz_pb2_grpc.QgisServerServicer, WorkerMixIn):
    ...
    async def Ping(
        self,
        request: qjazz_pb2.PingRequest,
        context: grpc.aio.ServicerContext,
    ) -> qjazz_pb2.PingReply:
        """  Simple ping request
        """
        logger.debug("QgisServer: Received PING request")
        return qjazz_pb2.PingReply(echo=request.echo)
    ...
    async def ExecuteOwsRequest(
        self,
        request: qjazz_pb2.OwsRequest,
        context: grpc.aio.ServicerContext,
    ) -> AsyncIterator[qjazz_pb2.ResponseChunk]:
        ...
        async with self.get_worker(context, "ExecuteOwsRequest", request) as worker:
            ...
            async for chunk in stream:
                size += len(chunk)
                yield qjazz_pb2.ResponseChunk(chunk=chunk)
...
class QgisAdmin(qjazz_pb2_grpc.QgisAdminServicer, WorkerMixIn):
    ...
    async def Sleep(
        self,
        request: qjazz_pb2.SleepRequest,
        context: grpc.aio.ServicerContext,
    ) -> qjazz_pb2.Empty:
        """  Simple ping request
        """
        ...
        return qjazz_pb2.Empty()

    async def SetServerServingStatus(
        self,
        request: qjazz_pb2.ServerStatus,
        context: grpc.aio.ServicerContext,
    ) -> qjazz_pb2.Empty:
        ...
        match request.status:
            case qjazz_pb2.ServingStatus.SERVING:
                status = ServingStatus.SERVING
            case qjazz_pb2.ServingStatus.NOT_SERVING:
    ...
    async def CheckoutProject(
        self,
        request: qjazz_pb2.CheckoutRequest,
        context: grpc.aio.ServicerContext,
    ...
    async def PullProjects(
        self,
        requests: AsyncIterator[qjazz_pb2.ProjectRequest],
        context: grpc.aio.ServicerContext,
    ) -> AsyncIterator[qjazz_pb2.CacheInfo]:
    ...
    async def Catalog(
        self,
        request: qjazz_pb2.CatalogRequest,
        context: grpc.aio.ServicerContext,
    ...
    async def GetProjectInfo(
        self,
        request: qjazz_pb2.ProjectRequest,
        context: grpc.aio.ServicerContext,
    ) -> qjazz_pb2.ProjectInfo:

        def _layer(layer):
            return qjazz_pb2.ProjectInfo.Layer(
    ...
    async def ListPlugins(
        ...
        request: qjazz_pb2.Empty,
        context: grpc.aio.ServicerContext,
    ) -> AsyncIterator[qjazz_pb2.PluginInfo]:

        plugins = self._pool.list_plugins()
        for item in plugins:
            yield qjazz_pb2.PluginInfo(
                name=item.name,
                path=str(item.path),
    ...
    async def GetConfig(
        ...
        return qjazz_pb2.JsonConfig(json=rv)
    ...
    async def GetEnv(
        ...
        try:
            rv = qjazz_pb2.JsonConfig(json=json.dumps(self._pool.env))
        except WorkerError as e:
    ...
    async def Stats(
        ...
        request: qjazz_pb2.Empty,
        context: grpc.aio.ServicerContext,
    ) -> qjazz_pb2.StatsReply:
        # Server serving status
        return qjazz_pb2.StatsReply(
...
#
def _new_cache_info(resp: _m.CacheInfo) -> qjazz_pb2.CacheInfo:
