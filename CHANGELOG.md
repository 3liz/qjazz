...
* [qjazz-rpc] Fix `num_workers` invalid value
...
* [processes] Add store API
* [rpc] Add list plugins command to qjazz-config utility
* [rpc] Restore qjazz-rpc-client as script
